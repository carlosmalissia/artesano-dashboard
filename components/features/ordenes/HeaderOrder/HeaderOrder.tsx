...
import { FormCreateOrder } from '@/components/features/ordenes/FormCreateOrder/FormCreateOrder';
        ...
        <DialogContent className="sm:max-w-[625px]">
          ...
          >
            <DialogHeader>
              ...
              <DialogDescription>Crear y configurar nueva factura</DialogDescription>
            </DialogHeader>
