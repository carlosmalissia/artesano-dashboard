...
import { FormCreateSeller } from '@/components/features/vendedores/FormCreateSeller/FormCreateSeller';
...
export function HeaderSellers({ userId, refetchVendedores, customer }: Props) {
  ...
  return (
    <div className="flex justify-between items-center">
      <h2 className="text-2xl">{customer ? 'Listado de Usuarios' : 'Listado de Vendedores'}</h2>
        ...
        <DialogContent className="sm:max-w-[625px]">
          ...
          >
            <DialogHeader>
              ...
              <DialogDescription>Crear y configurar nuevo</DialogDescription>
            </DialogHeader>
